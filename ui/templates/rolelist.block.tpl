...
<div style="float:left; padding-top:7px;"><a href="{"roles_del"|___:$role.roleid}" class="delimg" title="Rolle löschen" onClick="return confirm('Rolle wirklich löschen?');">&nbsp;</a></div>
