...
<div class="tabbable">
	<ul class="nav nav-tabs">
		<li class="active"><a href="#dokumentdetails-kartei" data-toggle="tab">{"Kartei"|__}</a></li>
		<li><a href="#dokumentdetails-historie" data-toggle="tab">{"Historie"|__}</a></li>
		<li><a href="#dokumentdetails-links" data-toggle="tab">{"Verknüpfungen"|__}</a></li>
	</ul>
	<div class="tab-content">
		<div class="tab-pane active" id="dokumentdetails-kartei">
		...
		<div class="tab-pane" id="dokumentdetails-historie">
